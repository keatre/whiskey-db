...
- Cloudflare tunnel requests are now excluded from LAN-guest privileges so remote visitors must authenticate even when `ALLOW_LAN_GUEST=true` (`api/app/deps.py`, `README.md`, `SECURITY.md`).
